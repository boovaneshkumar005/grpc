...
const file_proto_product_proto_rawDesc = "" +
	...
	"\x05price\x18\x03 \x01(\x01R\x05price2\xa4\x01\n" +
	"\x0eProductService\x12E\n" +
	"\n" +
	"GetProduct\x12\x1a.product.GetProductRequest\x1a\x1b.product.GetProductResponse\x12K\n" +
	"\fListProducts\x12\x1c.product.ListProductsRequest\x1a\x1d.product.ListProductsResponseB Z\x1eecommerce-grpc/proto/productpbb\x06proto3"
...
var file_proto_product_proto_depIdxs = []int32{
	...
	4, // 1: product.ListProductsResponse.products:type_name -> product.Product
